...
| Qatlam | Soni | Buyruq |
|---|---|---|
| Backend unit | 265 | `npm test --workspace=@karvon/api` |
| Backend uchidan-uchiga | 560 | `bash scripts/test-all.sh` |
| Admin panel | 194 | `npm run admin:test` |
| Mobil unit/widget | 353 | `npm run mobile:test` |
...
| — | [docs/legal/](docs/legal/) | **Maxfiylik siyosati, foydalanish shartlari, hisobni o'chirish sahifasi** (loyiha — yurist tasdig'i kerak) |
