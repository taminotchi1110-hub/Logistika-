...
| GET | `/me/export` | **Ma'lumotlarimning nusxasi** (maxfiylik siyosati, 7-bo'lim). Profil, transport, e'lon va buyurtmalar, yozishmalar, reytinglar, moliya va kirish tarixi bitta JSON da. Tokenlar, shifrlangan hujjat raqamlari va ikkinchi tomonning to'liq raqami KIRMAYDI. Soatiga 5 marta |
